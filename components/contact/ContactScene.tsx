 ...
 * clouds, tree and striped hill in front of it.
 *
...
export const ContactBackdrop = ({ className }: { className?: string }) => (
  <svg
    aria-hidden
    viewBox={VIEWBOX}
    fill="none"
...
export const ContactForeground = ({ className }: { className?: string }) => {
