...
export const TroublesHeroSection: React.FC = () => {
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 bg-[#FAF8F5] overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-msk-rose-200/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob"></div>
      ...
      <div className="absolute -bottom-8 left-20 w-96 h-96 bg-msk-sky-200/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000"></div>
      ...
      <div className="container mx-auto px-4 relative z-10 text-center max-w-4xl">
        <motion.span
          ...
          className="text-sm font-bold uppercase tracking-widest text-msk-forest-500 mb-4 block"
        >
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-msk-forest-950 mb-6 leading-tight"
        >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-msk-forest-700/80 max-w-3xl mx-auto leading-relaxed"
        >
