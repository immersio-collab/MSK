...
export const EquipePhilosophieSection: React.FC = () => {
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-10 left-10 text-[20rem] leading-none text-msk-forest-50 font-serif z-0 select-none">
        &ldquo;
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 space-y-8">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-msk-forest-950">
                La neurodiversité n'est pas un obstacle, c'est un autre chemin.
              </h2>
            </div>
            
            <blockquote className="text-xl md:text-2xl text-msk-forest-700/80 italic border-l-4 border-msk-sun-400 pl-6 leading-relaxed">
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <div>
                <p className="font-bold text-msk-forest-900">Khadija Elabaya</p>
                <p className="text-sm text-msk-forest-600">Fondatrice de MSK Montessori</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 w-full">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl group cursor-pointer bg-msk-forest-100">
              <Image 
              ...
              />
              <div className="absolute inset-0 bg-msk-forest-950/30 flex items-center justify-center transition-colors group-hover:bg-msk-forest-950/40">
                {/* Play button UI */}
              ...
              <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur px-4 py-2 rounded-full text-xs font-bold text-msk-forest-900 shadow-sm">
