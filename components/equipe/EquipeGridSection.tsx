  ...
  return (
    <section className="py-20 bg-[#FAF8F5]">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="bg-white rounded-3xl overflow-hidden shadow-xl border border-msk-forest-100 flex flex-col md:flex-row">
          {/* Left: Photo */}
          <div className="md:w-2/5 relative h-[400px] md:h-auto">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-msk-forest-950/60 to-transparent md:hidden"></div>
          ...
          <div className="md:w-3/5 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
            <div className="hidden md:block mb-8">
              <h3 className="text-4xl font-bold text-msk-forest-950 mb-2">Khadija Elabaya</h3>
            ...
            <div className="space-y-6">
              <p className="text-lg text-msk-forest-700/90 leading-relaxed">
              ...
              <div>
                <h4 className="text-sm font-bold uppercase tracking-widest text-msk-forest-500 mb-4 border-b border-msk-forest-100 pb-2">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={idx} className="flex items-start gap-3">
                      ...
                      <span className="text-msk-forest-800 font-medium">{specialty}</span>
                    </li>
                  ))}
                </ul>
              </div>
