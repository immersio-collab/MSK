...
export const BrandLogo: React.FC<BrandLogoProps> = ({ className = "", variant = "default" }) => {
  ...
  return (
    ...
    >
      ...
      <span className={`text-3xl sm:text-4xl md:text-[38px] font-black tracking-tight ${isWhite ? "text-white" : "text-msk-coral-500"}`}>
        msk<span className="inline-flex items-center gap-1.5 ml-1 align-baseline">
