...
export const metadata: Metadata = {
  title: "Petite Enfance (2-5 ans) | MSK Casablanca",
  description: "Cycle Petite Enfance Montessori 2 à 5 ans.",
};

export default function PetiteEnfancePage() {
  const sections = [
    { id: "hero", title: "Petite Enfance (2 à 5 ans) — Introduction" },
    { id: "ambiance", title: "Ambiance Montessori, Éveil & Autonomie" },
    { id: "cta", title: "Demande de Place en Petite Enfance" },
  ];
