...
export const metadata: Metadata = {
  title: "Adolescents (12 ans et +) | MSK Casablanca",
  description: "Programme Adolescents à MSK Casablanca.",
};

export default function AdolescentsPage() {
  const sections = [
    { id: "hero", title: "Programme Adolescents (12 ans et +) — Introduction" },
    { id: "methodologie", title: "Méthodologie, Autonomie & Coaching de Réussite" },
    { id: "cta", title: "Entretien d'Orientation Adolescent" },
  ];
