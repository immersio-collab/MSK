...
export const metadata: Metadata = {
  title: "Cycle Primaire (6-11 ans) | MSK Casablanca",
  description: "Cycle Primaire 6 à 11 ans chez MSK Casablanca.",
};

export default function PrimairePage() {
  const sections = [
    { id: "hero", title: "Cycle Primaire (6 à 11 ans) — Introduction" },
    { id: "pedagogie", title: "Apprentissages Fondamentaux, Remédiation & Neuro-Gym" },
    { id: "cta", title: "Demande d'Admission en Primaire" },
  ];
