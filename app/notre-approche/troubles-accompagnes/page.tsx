...
export const metadata: Metadata = {
  title: "Troubles Accompagnés | MSK Casablanca",
  description: "Accompagnement des troubles des apprentissages, TDA/TDAH et psychomotricité.",
};

export default function TroublesAccompagnesPage() {
  const sections = [
    { id: "hero", title: "Troubles Accompagnés — Accueillir sans Stigmatiser" },
    { id: "profils", title: "Profils Accompagnés (DYS, TDAH, Langage, Motricité)" },
    { id: "cta", title: "Demande d'Entretien" },
  ];
